  ...
  return (
    <div className="relative min-h-screen w-full text-foreground bg-background overflow-x-hidden">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 py-10">
        ...
        {/* Quick link to Engage features */}
        <div className="mt-8">
          <Panel className="p-6 bg-gradient-to-r from-primary/10 to-transparent border-l-4 border-primary">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <h3 className="font-semibold text-lg mb-1">Amplify Your Impact</h3>
                <p className="text-sm text-muted-foreground">
                  Track your referral network, check daily pulse, unlock badges, and access sharing tools
                </p>
              </div>
              <a 
                href="/engage"
                className="rounded-xl bg-primary hover:bg-primary/90 px-6 py-3 text-sm font-semibold transition-colors whitespace-nowrap shadow-lg"
              >
                Explore Engage Tools →
              </a>
            </div>
          </Panel>
        </div>
